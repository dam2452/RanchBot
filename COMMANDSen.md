...
- **`/p_en`** / **`/pl_en`** / **`/szp_en`**: 👤 Same as above, but output in English.
...
- **`/obj_en`** / **`/objl_en`** / **`/szo_en`**: 🎯 Same as above, but output in English.
...
- **`/p_en`**: 👤 Same as `/p`, but output in English.
- **`/pl_en`**: 👤 Same as `/pl`, but output in English.
- **`/szp_en`**: 👤 Same as `/szp`, but output in English.
...
- **`/obj_en`**: 🎯 Same as `/obj`, but output in English.
...
- **`/objl_en`**: 🎯 Same as `/objl`, but output in English.
- **`/szo_en`**: 🎯 Same as `/szo`, but output in English.
