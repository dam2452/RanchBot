...
def search(  # pylint: disable=too-many-arguments,too-many-locals,too-many-statements
    ...
    from preprocessor.modules.search.clients.elasticsearch_queries import ElasticsearchQueries  # pylint: disable=import-outside-toplevel
    from preprocessor.modules.search.clients.embedding_service import EmbeddingService  # pylint: disable=import-outside-toplevel
    from preprocessor.modules.search.clients.hash_service import HashService  # pylint: disable=import-outside-toplevel
    from preprocessor.modules.search.clients.result_formatters import ResultFormatter  # pylint: disable=import-outside-toplevel
