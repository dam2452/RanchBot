...
class ElasticSearchIndexer:
    ...
    async def __load_all_seasons_actions(self) -> List[Dict[str, Any]]:
        actions = []
    ...
    async def __load_season(self, season_path: Path) -> List[Dict[str, Any]]:
        season_actions = []
    ...
    async def __load_episode(self, episode_file: Path) -> List[Dict[str, Any]]:
