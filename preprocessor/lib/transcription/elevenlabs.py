...
from preprocessor.lib.transcription.engines.elevenlabs_engine import ElevenLabsEngine
from preprocessor.lib.transcription.generators.multi_format_generator import MultiFormatGenerator
    ...
    def __create_segments_from_words(words: List[Dict]) -> List[Dict]:
        ...
        for word in words:
            ...
            if current_speaker is None:
                ...
                segments.append({'text': segment_text, 'words': current_segment_words})
                current_speaker = speaker_id
                current_segment_words = [word]
