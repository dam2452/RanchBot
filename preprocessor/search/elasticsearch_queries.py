...
from preprocessor.search.embedding_service import EmbeddingService
...
class ElasticsearchQueries:
    ...
    async def search_text_query(
        ...
        return await es_client.search(
            ...
            size=limit,
            _source=[
                "episode_id", "segment_id", "text", "start_time", "end_time",
                "speaker", "video_path", "episode_metadata", "scene_info",
            ],
        )
    ...
    async def search_by_object(
        ...
        return await es_client.search(
            ...
            size=limit,
            _source=[
                "episode_id", "frame_number", "timestamp", "detected_objects",
                "character_appearances", "video_path", "episode_metadata", "scene_info",
            ],
        )
