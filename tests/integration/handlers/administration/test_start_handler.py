...
class TestStartHandlerIntegration(BaseIntegrationTest):
    ...
    @pytest.mark.asyncio
    async def test_start_basic_message(self):
    ...
    @pytest.mark.asyncio
    async def test_start_help_alias(self):
    ...
    @pytest.mark.asyncio
    async def test_start_pomoc_alias(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_lista_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_wszystko_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_wyszukiwanie_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_edycja_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_zarzadzanie_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_raportowanie_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_subskrypcje_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_skroty_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_invalid_argument(self):
    ...
    @pytest.mark.asyncio
    async def test_start_with_too_many_arguments(self):
